<x-guest-layout>
    ...
    <h4 class="text-center mb-3">{{ __('Create New Account') }}</h4>
    <h6 class="text-center">Please provide valid credential details</h6>
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            <x-input-label for="acct_currency" :value="__('Currency')" />
            <select id="acct_currency" class="block mt-1 w-full" name="acct_currency" required>
            ...
            <x-input-error :messages="$errors->get('acct_currency')" class="mt-2" />
        </div>
