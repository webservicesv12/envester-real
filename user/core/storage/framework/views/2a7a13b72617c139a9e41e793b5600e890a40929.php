                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" name="stripe_client_id" class="form-control"
                                            ...
                                            value="<?php echo e(@$gateway->gateway_parameters->stripe_client_id ?? old('stripe_client_id')); ?>">
                                    </div>
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" name="stripe_client_secret" class="form-control"
                                            ...
                                            value="<?php echo e(@$gateway->gateway_parameters->stripe_client_secret ?? old('stripe_client_secret')); ?>">
                                    </div>
...
<?php echo $__env->make('backend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/sites/envestar/user/core/resources/views/backend/gateways/stripe.blade.php ENDPATH**/ ?>